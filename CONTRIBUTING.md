...
issue](https://github.com/cisagov/ansible-role-openjdk/issues) in
...
request](https://github.com/cisagov/ansible-role-openjdk/pulls), you
...
pyenv virtualenv <python_version_to_use> ansible-role-openjdk
pyenv local ansible-role-openjdk
